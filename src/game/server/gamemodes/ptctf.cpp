...
CGameControllerPTCTF::CGameControllerPTCTF(class CGameContext *pGameServer)
...
bool CGameControllerPTCTF::OnEntity(int Index, vec2 Pos)
{
...
int CGameControllerPTCTF::OnCharacterDeath(class CCharacter *pVictim, class CPlayer *pKiller, int WeaponID)
{
...
void CGameControllerPTCTF::DoWincheck()
{
...
bool CGameControllerPTCTF::CanBeMovedOnBalance(int ClientID)
{
...
void CGameControllerPTCTF::Snap(int SnappingClient)
{
...
void CGameControllerPTCTF::Tick()
{
...
void CGameControllerPTCTF::OnMessage(int MsgID, class CUnpacker *pUnpacker, int ClientID)
{
    IGameController::OnMessage(MsgID, pUnpacker, ClientID);
    
}

void CGameControllerPTCTF::PostReset()
{
