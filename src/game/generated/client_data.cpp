...
static CDataSound x2021[] = {
	/* x2021[0] */ {  0,  "audio/wp_rifle_fire-01.wv", },
	/* x2021[1] */ {  0,  "audio/wp_rifle_fire-02.wv", },
	/* x2021[2] */ {  0,  "audio/wp_rifle_fire-03.wv", },
};
static CDataSound x2037[] = {
	/* x2037[0] */ {  0,  "audio/wp_rifle_bnce-01.wv", },
	/* x2037[1] */ {  0,  "audio/wp_rifle_bnce-02.wv", },
	/* x2037[2] */ {  0,  "audio/wp_rifle_bnce-03.wv", },
};
...
static CDataSoundset x9[] = {
	...
	/* x9[8] */ {  "rifle_fire",  3,x2021,  -1, },
	/* x9[9] */ {  "rifle_bounce",  3,x2037,  -1, },
...
static CDataImage x14[] = {
	...
	/* x14[9] */ {  "demobuttons",  "demo_buttons.png",  -1, },
	/* x14[10] */ {  "fileicons",  "file_icons.png",  -1, },
	/* x14[11] */ {  "guibuttons",  "gui_buttons.png",  -1, },
	/* x14[12] */ {  "guiicons",  "gui_icons.png",  -1, },
};
...
static CDataSprite x44[] = {
	...
	/* x44[29] */ {  "weapon_gun_muzzle1",  &x28[1],  8,  4,  3,  2, },
	/* x44[30] */ {  "weapon_gun_muzzle2",  &x28[1],  12,  4,  3,  2, },
	/* x44[31] */ {  "weapon_gun_muzzle3",  &x28[1],  16,  4,  3,  2, },
	...
	/* x44[35] */ {  "weapon_shotgun_muzzle1",  &x28[1],  12,  6,  3,  2, },
	/* x44[36] */ {  "weapon_shotgun_muzzle2",  &x28[1],  16,  6,  3,  2, },
	/* x44[37] */ {  "weapon_shotgun_muzzle3",  &x28[1],  20,  6,  3,  2, },
	...
	/* x44[47] */ {  "weapon_rifle_body",  &x28[1],  2,  12,  7,  3, },
	/* x44[48] */ {  "weapon_rifle_cursor",  &x28[1],  0,  12,  2,  2, },
	/* x44[49] */ {  "weapon_rifle_proj",  &x28[1],  10,  12,  2,  2, },
	...
	/* x44[57] */ {  "pickup_weapon",  &x28[1],  3,  0,  6,  2, },
	/* x44[58] */ {  "pickup_ninja",  &x28[1],  2,  10,  8,  2, },
	/* x44[59] */ {  "flag_blue",  &x28[1],  12,  8,  4,  8, },
	/* x44[60] */ {  "flag_red",  &x28[1],  16,  8,  4,  8, },
	/* x44[61] */ {  "flag_yellow",  &x28[1],  20,  8,  4,  8, },
	/* x44[62] */ {  "tee_body",  &x28[2],  0,  0,  3,  3, },
	/* x44[63] */ {  "tee_body_outline",  &x28[2],  3,  0,  3,  3, },
	/* x44[64] */ {  "tee_foot",  &x28[2],  6,  1,  2,  1, },
	/* x44[65] */ {  "tee_foot_outline",  &x28[2],  6,  2,  2,  1, },
	/* x44[66] */ {  "tee_hand",  &x28[2],  6,  0,  1,  1, },
	/* x44[67] */ {  "tee_hand_outline",  &x28[2],  7,  0,  1,  1, },
	/* x44[68] */ {  "tee_eye_normal",  &x28[2],  2,  3,  1,  1, },
	/* x44[69] */ {  "tee_eye_angry",  &x28[2],  3,  3,  1,  1, },
	/* x44[70] */ {  "tee_eye_pain",  &x28[2],  4,  3,  1,  1, },
	/* x44[71] */ {  "tee_eye_happy",  &x28[2],  5,  3,  1,  1, },
	/* x44[72] */ {  "tee_eye_dead",  &x28[2],  6,  3,  1,  1, },
	/* x44[73] */ {  "tee_eye_surprise",  &x28[2],  7,  3,  1,  1, },
	/* x44[74] */ {  "oop",  &x28[4],  0,  0,  1,  1, },
	/* x44[75] */ {  "exclamation",  &x28[4],  1,  0,  1,  1, },
	/* x44[76] */ {  "hearts",  &x28[4],  2,  0,  1,  1, },
	/* x44[77] */ {  "drop",  &x28[4],  3,  0,  1,  1, },
	/* x44[78] */ {  "dotdot",  &x28[4],  0,  1,  1,  1, },
	/* x44[79] */ {  "music",  &x28[4],  1,  1,  1,  1, },
	/* x44[80] */ {  "sorry",  &x28[4],  2,  1,  1,  1, },
	/* x44[81] */ {  "ghost",  &x28[4],  3,  1,  1,  1, },
	/* x44[82] */ {  "sushi",  &x28[4],  0,  2,  1,  1, },
	/* x44[83] */ {  "splattee",  &x28[4],  1,  2,  1,  1, },
	/* x44[84] */ {  "deviltee",  &x28[4],  2,  2,  1,  1, },
	/* x44[85] */ {  "zomg",  &x28[4],  3,  2,  1,  1, },
	/* x44[86] */ {  "zzz",  &x28[4],  0,  3,  1,  1, },
	/* x44[87] */ {  "wtf",  &x28[4],  1,  3,  1,  1, },
	/* x44[88] */ {  "eyes",  &x28[4],  2,  3,  1,  1, },
	/* x44[89] */ {  "question",  &x28[4],  3,  3,  1,  1, },
	/* x44[90] */ {  "browse_lock",  &x28[3],  0,  0,  1,  1, },
	/* x44[91] */ {  "browse_heart",  &x28[3],  1,  0,  1,  1, },
	/* x44[92] */ {  "browse_unpure",  &x28[3],  3,  0,  1,  1, },
	/* x44[93] */ {  "demobutton_play",  &x28[5],  0,  0,  1,  1, },
	/* x44[94] */ {  "demobutton_pause",  &x28[5],  1,  0,  1,  1, },
	/* x44[95] */ {  "demobutton_stop",  &x28[5],  2,  0,  1,  1, },
	/* x44[96] */ {  "demobutton_slower",  &x28[5],  3,  0,  1,  1, },
	/* x44[97] */ {  "demobutton_faster",  &x28[5],  4,  0,  1,  1, },
	/* x44[98] */ {  "file_demo1",  &x28[6],  0,  0,  1,  1, },
	/* x44[99] */ {  "file_demo2",  &x28[6],  1,  0,  1,  1, },
	/* x44[100] */ {  "file_folder",  &x28[6],  2,  0,  1,  1, },
	/* x44[101] */ {  "file_map1",  &x28[6],  5,  0,  1,  1, },
	/* x44[102] */ {  "file_map2",  &x28[6],  6,  0,  1,  1, },
	/* x44[103] */ {  "guibutton_off",  &x28[7],  0,  0,  4,  4, },
	/* x44[104] */ {  "guibutton_on",  &x28[7],  4,  0,  4,  4, },
	/* x44[105] */ {  "guibutton_hover",  &x28[7],  8,  0,  4,  4, },
	/* x44[106] */ {  "guiicon_mute",  &x28[8],  0,  0,  4,  2, },
	/* x44[107] */ {  "guiicon_friend",  &x28[8],  4,  0,  4,  2, },
};
static CAnimKeyframe x4291[] = {
	/* x4291[0] */ {  0.000000,  0.000000,  -4.000000,  0.000000, },
};
static CAnimKeyframe x4298[] = {
	/* x4298[0] */ {  0.000000,  0.000000,  10.000000,  0.000000, },
};
static CAnimKeyframe x4305[] = {
	/* x4305[0] */ {  0.000000,  0.000000,  10.000000,  0.000000, },
};
static CAnimKeyframe *x4312 = 0;
static CAnimKeyframe *x4336 = 0;
static CAnimKeyframe x4343[] = {
	/* x4343[0] */ {  0.000000,  -7.000000,  0.000000,  0.000000, },
};
static CAnimKeyframe x4350[] = {
	/* x4350[0] */ {  0.000000,  7.000000,  0.000000,  0.000000, },
};
static CAnimKeyframe *x4357 = 0;
static CAnimKeyframe *x4376 = 0;
static CAnimKeyframe x4383[] = {
	/* x4383[0] */ {  0.000000,  -3.000000,  0.000000,  -0.100000, },
};
static CAnimKeyframe x4390[] = {
	/* x4390[0] */ {  0.000000,  3.000000,  0.000000,  -0.100000, },
};
static CAnimKeyframe *x4397 = 0;
static CAnimKeyframe x4416[] = {
	/* x4416[0] */ {  0.000000,  0.000000,  0.000000,  0.000000, },
	/* x4416[1] */ {  0.200000,  0.000000,  -1.000000,  0.000000, },
	/* x4416[2] */ {  0.400000,  0.000000,  0.000000,  0.000000, },
	/* x4416[3] */ {  0.600000,  0.000000,  0.000000,  0.000000, },
	/* x4416[4] */ {  0.800000,  0.000000,  -1.000000,  0.000000, },
	/* x4416[5] */ {  1.000000,  0.000000,  0.000000,  0.000000, },
};
static CAnimKeyframe x4423[] = {
	/* x4423[0] */ {  0.000000,  8.000000,  0.000000,  0.000000, },
	/* x4423[1] */ {  0.200000,  -8.000000,  0.000000,  0.000000, },
	/* x4423[2] */ {  0.400000,  -10.000000,  -4.000000,  0.200000, },
	/* x4423[3] */ {  0.600000,  -8.000000,  -8.000000,  0.300000, },
	/* x4423[4] */ {  0.800000,  4.000000,  -4.000000,  -0.200000, },
	/* x4423[5] */ {  1.000000,  8.000000,  0.000000,  0.000000, },
};
static CAnimKeyframe x4430[] = {
	/* x4430[0] */ {  0.000000,  -10.000000,  -4.000000,  0.200000, },
	/* x4430[1] */ {  0.200000,  -8.000000,  -8.000000,  0.300000, },
	/* x4430[2] */ {  0.400000,  4.000000,  -4.000000,  -0.200000, },
	/* x4430[3] */ {  0.600000,  8.000000,  0.000000,  0.000000, },
	/* x4430[4] */ {  0.800000,  8.000000,  0.000000,  0.000000, },
	/* x4430[5] */ {  1.000000,  -10.000000,  -4.000000,  0.200000, },
};
static CAnimKeyframe *x4437 = 0;
static CAnimKeyframe *x4536 = 0;
static CAnimKeyframe *x4543 = 0;
static CAnimKeyframe *x4550 = 0;
static CAnimKeyframe x4557[] = {
	/* x4557[0] */ {  0.000000,  0.000000,  0.000000,  -0.100000, },
	/* x4557[1] */ {  0.300000,  0.000000,  0.000000,  0.250000, },
	/* x4557[2] */ {  0.400000,  0.000000,  0.000000,  0.300000, },
	/* x4557[3] */ {  0.500000,  0.000000,  0.000000,  0.250000, },
	/* x4557[4] */ {  1.000000,  0.000000,  0.000000,  -0.100000, },
};
static CAnimKeyframe *x4591 = 0;
static CAnimKeyframe *x4598 = 0;
static CAnimKeyframe *x4605 = 0;
static CAnimKeyframe x4612[] = {
	/* x4612[0] */ {  0.000000,  0.000000,  0.000000,  -0.250000, },
	/* x4612[1] */ {  0.100000,  0.000000,  0.000000,  -0.050000, },
	/* x4612[2] */ {  0.150000,  0.000000,  0.000000,  0.350000, },
	/* x4612[3] */ {  0.420000,  0.000000,  0.000000,  0.400000, },
	/* x4612[4] */ {  0.500000,  0.000000,  0.000000,  0.350000, },
	/* x4612[5] */ {  1.000000,  0.000000,  0.000000,  -0.250000, },
};
static CAnimation x75[] = {
	/* x75[0] */ {  "base",  /* x75[0].body */ {  1,x4291, },  /* x75[0].back_foot */ {  1,x4298, },  /* x75[0].front_foot */ {  1,x4305, },  /* x75[0].attach */ {  0,x4312, }, },
	/* x75[1] */ {  "idle",  /* x75[1].body */ {  0,x4336, },  /* x75[1].back_foot */ {  1,x4343, },  /* x75[1].front_foot */ {  1,x4350, },  /* x75[1].attach */ {  0,x4357, }, },
	/* x75[2] */ {  "inair",  /* x75[2].body */ {  0,x4376, },  /* x75[2].back_foot */ {  1,x4383, },  /* x75[2].front_foot */ {  1,x4390, },  /* x75[2].attach */ {  0,x4397, }, },
	/* x75[3] */ {  "walk",  /* x75[3].body */ {  6,x4416, },  /* x75[3].back_foot */ {  6,x4423, },  /* x75[3].front_foot */ {  6,x4430, },  /* x75[3].attach */ {  0,x4437, }, },
	/* x75[4] */ {  "hammer_swing",  /* x75[4].body */ {  0,x4536, },  /* x75[4].back_foot */ {  0,x4543, },  /* x75[4].front_foot */ {  0,x4550, },  /* x75[4].attach */ {  5,x4557, }, },
	/* x75[5] */ {  "ninja_swing",  /* x75[5].body */ {  0,x4591, },  /* x75[5].back_foot */ {  0,x4598, },  /* x75[5].front_foot */ {  0,x4605, },  /* x75[5].attach */ {  6,x4612, }, },
};
static CDataSprite* *x4769 = 0;
static CDataSprite* x4906[] = {
	&x44[29],
	&x44[30],
	&x44[31],
};
static CDataSprite* x5091[] = {
	&x44[35],
	&x44[36],
	&x44[37],
};
static CDataSprite* *x5276 = 0;
static CDataSprite* *x5413 = 0;
static CDataSprite* x5550[] = {
	&x44[52],
	&x44[53],
	&x44[54],
};
static CDataWeaponspec x1887[] = {
	/* x1887[0] */ {  "hammer",  &x44[41],  &x44[42],  &x44[43],  0,x4769,  96,  125,  10,  0,  3,  4.000000,  -20.000000,  0.000000,  0.000000,  5.000000, },
	/* x1887[1] */ {  "gun",  &x44[26],  &x44[27],  &x44[28],  3,x4906,  64,  125,  10,  500,  1,  32.000000,  4.000000,  50.000000,  6.000000,  5.000000, },
	/* x1887[2] */ {  "shotgun",  &x44[32],  &x44[33],  &x44[34],  3,x5091,  96,  500,  10,  0,  1,  24.000000,  -2.000000,  70.000000,  6.000000,  5.000000, },
	/* x1887[3] */ {  "grenade",  &x44[38],  &x44[39],  &x44[40],  0,x5276,  96,  500,  10,  0,  1,  24.000000,  -2.000000,  0.000000,  0.000000,  5.000000, },
	/* x1887[4] */ {  "rifle",  &x44[47],  &x44[48],  &x44[49],  0,x5413,  92,  800,  10,  0,  5,  24.000000,  -2.000000,  0.000000,  0.000000,  5.000000, },
	/* x1887[5] */ {  "ninja",  &x44[44],  &x44[45],  &x44[46],  3,x5550,  96,  800,  10,  0,  9,  0.000000,  0.000000,  40.000000,  -4.000000,  5.000000, },
};
